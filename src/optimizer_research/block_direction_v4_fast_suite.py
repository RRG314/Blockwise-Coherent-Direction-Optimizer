...
def export_block_direction_v4_fast_report(output_dir: str | Path = DEFAULT_OUTPUT_DIR) -> dict[str, Any]:
    ...
    lines = [
        ...
        "",
        f"- BCDO wins vs the legacy fast path: `{v4_vs.get('block_direction_optimizer_v4_fast_legacy', 0)}` meaningful wins.",
        f"- BCDO wins vs the reference CNN branch: `{v4_vs.get('block_direction_optimizer_v42', 0)}` meaningful wins.",
        ...
        f"- BCDO wins vs MagnetoHamiltonianAdam: `{v4_vs.get('magneto_hamiltonian_adam', 0)}` meaningful wins.",
        "",
        "## 5. Runtime",
        "",
