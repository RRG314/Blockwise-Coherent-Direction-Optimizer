...
from optimizers.hamiltonian_adam import HamiltonianAdam, HamiltonianAdamReal
...
def build_optimizer_registry() -> dict[str, OptimizerSpec]:
    return {
        ...
        "bcdo_direction_selection_base": OptimizerSpec(
            "bcdo_direction_selection_base",
        ...
        "bcdo_structured_core": OptimizerSpec(
            "bcdo_structured_core",
            BCDOStructuredCore,
            {
                "lr": 1.8e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart_bcdo_structured",
            ...
            },
            {
                ...
                "weight_decay": [0.0, 1e-5, 1e-4],
                "block_strategy": ["smart_bcdo_structured", "row", "column", "scalar", "tensor"],
                "selection_mode": ["winner_take_all", "top2_blend", "softmax_weighted_average", "fallback_to_gradient"],
        ...
        "blockwise_consensus_direction_optimizer": OptimizerSpec(
            "blockwise_consensus_direction_optimizer",
            BlockwiseConsensusDirectionOptimizer,
            {
                "lr": 1.5e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart_bcdo",
                "selection_mode": "winner_take_all",
                "selection_temperature": 0.25,
                "memory_decay": 0.88,
                "smooth_decay": 0.96,
            ...
            },
            {
                ...
                "weight_decay": [0.0, 1e-5, 1e-4],
                "block_strategy": ["smart_bcdo", "tensor", "row"],
        ...
        "blockwise_consensus_direction_optimizer_legacy": OptimizerSpec(
        ...
        "bcdo_cnn_reference": OptimizerSpec(
            "bcdo_cnn_reference",
            BCDOCNNReference,
            {
                "lr": 1.2e-2,
