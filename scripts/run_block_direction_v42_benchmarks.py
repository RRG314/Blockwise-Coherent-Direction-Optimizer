...
from optimizer_research import block_direction_v42_default_config, load_yaml_config, run_block_direction_v42_benchmarks  # noqa: E402
...
if __name__ == "__main__":
    ...
    run_block_direction_v42_benchmarks(config)
